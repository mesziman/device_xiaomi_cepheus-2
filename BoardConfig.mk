...
BOARD_KERNEL_CMDLINE += service_locator.enable=1 loop.max_part=7 androidboot.usbcontroller=a600000.dwc3
...
TARGET_PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt_memeuikernal/kernal
